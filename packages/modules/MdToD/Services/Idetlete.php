...
function ltBaseUrl()
{//e.g https://www.lifetech.host
    return (isHttps() ? 'https://' : 'http://') . ltDomain();
}
    ...
    <div class="step animate-enter" data-step="1">
      ...
      <ul class="space-y-3 mb-8 bg-gray-50 p-4 rounded-lg border border-gray-100">
        <li class="flex justify-between items-center">
            ...
            <? else: ?>
                <span class="text-red-800 bg-red-300 hover:shadow hover:text-shadow-lg text-lg px-2 py-1 rounded font-bold">Upload Max Size</span>
